...
const char* FACTOR_OUTPUT_TEMPLATE_FIRST_LINE = "|%-11ld|%-13ld|";
const char* FACTOR_OUTPUT_TEMPLATE_FIRST_LINE_WITHOUT_PRIME = "|%-11ld|             |";
const char* FACTOR_COUNT = " Please enter number of terms: ";
